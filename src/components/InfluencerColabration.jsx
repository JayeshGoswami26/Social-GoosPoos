          ...
          <div className="container lg:flex relative">
            <div className="max-w-[40rem] relative z-1">
              ...
              <ul className="max-w-[22rem] mb-10 md:mb-14 ">
                {InfluencerCollabContent.map((item, index) => (
                  <motion.li
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{
            ...
            <div className="lg:ml-auto xl:w-[38rem] mt-10 ">
              <div className="relative left-1/2 flex w-[22rem] aspect-square -translate-x-1/2 scale:75 md:scale-100">
                <div className="">
                  <img
                    className="absolute animate-float -right-[7rem] -top-[5rem] md:-right-[10rem] md:-top-10 w-[100%] "
                    draggable="false"
                    src={avatar3}
                    alt=""
                  />
                  <img
                    className="absolute animate-float-reverse  right-0 md:right-0 "
                    src={avatar5}
                    draggable="false"
                    alt=""
                  />
                  <img
                    className="absolute animate-float -left-[7rem] top-[5rem] md:-left-[10rem] md:top-14 "
                    src={avatar4}
                    draggable="false"
                    alt=""
                  />
